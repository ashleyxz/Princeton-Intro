/******************************************************************************
 *  Compilation:  javac Barycenter.java
 *  Execution:    java Barycenter
 *
 *In a two-body system, the barycenter is the center of gravity about which
 * the two celestial bodies orbit each other.
 * Given the masses m1 and m2 of two bodies,
 * and the shortest distance a between the two bodies,
 * write a program to compute the distance from the center of the first (more massive) body
 * to the barycenter: r1 = a m2 / (m1 + m2).
